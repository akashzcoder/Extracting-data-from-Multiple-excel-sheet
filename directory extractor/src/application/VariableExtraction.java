...
public  boolean variable(String fileName2, String newfileName) throws IOException{
	if(newfileName == null){
		return false;
	}
	fileName_main = newfileName + "\\\\Variables.xls";
	boolean tf3=false;
...
public static boolean readParagraphs(HWPFDocument doc) throws Exception{
	...
	WordExtractor we = new WordExtractor(doc);
       ...
       for (int i = 0; i < paragraphs.length; i++) {
           ...
           {
           if((ch.charAt(i1)=='C' && ch.charAt(i1+1)=='_' && (ch.charAt(i1-1)==' '||ch.charAt(i1-1)=='(') ||ch.charAt(i1-1)=='<')&& ch.charAt(i1-1)!='_')
           {int x=i1-1;
           while(ch.charAt(x)!=' ')
           {
           str=str+ch.charAt(x);
           ...
           {
           if((ch.charAt(i1)=='N' && ch.charAt(i1+1)=='_') && (ch.charAt(i1-1)==' ' || ch.charAt(i1-1)=='('||ch.charAt(i1-1)=='<') && ch.charAt(i1-1)!='_')
           {int x=i1;
           while(ch.charAt(x)!=' ' || x == (l-1))
           {
           str=str+ch.charAt(x);
           x++;
           }
           ...
           for(int i1=0;i1<l-2;i1++)
           {
           if((ch.charAt(i1)=='D' && ch.charAt(i1+1)=='_') && (ch.charAt(i1-1)==' ' || ch.charAt(i1-1)=='('||ch.charAt(i1-1)=='<') && ch.charAt(i1-1)!='_')
           {int x=i1;
           while(ch.charAt(x)!=' ' || x == (l-1))
           {
           str=str+ch.charAt(x);
        ...
        if(ch.contains("cE")|| ch.contains("cF")||ch.contains("cM")||ch.contains("cN") || ch.contains("cS"))
           {
           l=ch.length();
           for(int i1=0;i1<l-2;i1++)
           {
           if((ch.charAt(i1)=='c' && (ch.charAt(i1+1)>='A' && ch.charAt(i1+1)<='Z') ))
           {int x=i1;
           while(ch.charAt(x)!=' ' || x == (l-1))
           {
           str=str+ch.charAt(x);
