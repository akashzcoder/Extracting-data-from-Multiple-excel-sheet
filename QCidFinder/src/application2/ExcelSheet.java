...
public class ExcelSheet {
 ...
 static String fileName = "C:\\temp\\Book1.xls";
  static String formname="Certificate";
 public static void main(String[] srgs){
	 ArrayList<String> yo = new ArrayList<String>();
	 yo=readExcelFile(fileName,formname);
	 System.out.println(yo);
 }

public static ArrayList<String> readExcelFile(String fileName, String formname)
{
    /** --Define a Vector
   ...
   //HSSFSheet mySheet = myWorkBook.getSheetAt(0);
    for (int i = 0; i < myWorkBook.getNumberOfSheets(); i++) {
        ...
        //.... ce to print the sheet's values here
        ...
        if(columnNo!= 0){
    		...
    		String[][] data=new String[rowNum][2];
